...
int* maxSubarray(int arr_count, int* arr, int* result_count) {
    *result_count = 2; // we will return 2 integers
    ...
    // Max subsequence: sum of positives, or max element if all negative
    ...
    int max_subsequence = has_positive ? sum_positive : max_element;
